...
def GetPatch(out_root, patch_size):
    ...
    Get image patch
    """
    t1 = get_image_paths('datasets/validation/t1')
    flair = get_image_paths('datasets/validation/t2-flair')
    label = get_image_paths('datasets/validation/label')
